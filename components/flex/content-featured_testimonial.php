...
<section class="section_featured_testimonial row-<?php echo $row; ?>">
    <div class="container">
        ...
        <div class="testimonial_cols">
            <div class="quote_marks_col">
                <img src="<?php echo get_template_directory_uri() . '/assets/images/svg/quotation-marks-magenta.svg'; ?>"
                    alt="quotation marks for testimonial">
            </div>
            <div class="text_col_1 fade_in_element fade-delay-1">
                <?php if($column_1['title']) { ?>
                <h3 class="col_title <?php if($column_1['border_title_col_1']) { ?> border_bottom <?php } ?>">
                    <?php echo $column_1['title']; ?>
                </h3>
                <?php } ?>

                <?php if($column_1['body']) { ?>
                <div class="col_body"><?php echo $column_1['body']; ?></div>
                <?php } ?>
            ...
            <div class="text_col_2  fade_in_element fade-delay-2">
                <?php if($column_2['title']) { ?><h3
                    ...
                    <?php echo $column_2['title']; ?></h3>
                <?php } ?>

                <?php if($column_2['body']) { ?>
                <div class="col_body"><?php echo $column_2['body']; ?></div>
                <?php } ?>
